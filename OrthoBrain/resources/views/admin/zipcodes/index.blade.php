...
<style>
    /* ── KPI strip ─────────────────────────────────────────────────── */
    .zi-kpis { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 1rem; margin-bottom: 1.25rem; }
    @media (max-width: 767.98px) { .zi-kpis { grid-template-columns: 1fr; } }
    .zi-kpi { display: flex; align-items: center; gap: .9rem; padding: 1rem 1.1rem; border-radius: .6rem;
              background: #fff; box-shadow: 0 2px 8px rgba(34, 41, 47, .05); border: 1px solid rgba(34, 41, 47, .05); }
    .zi-kpi__icon { width: 42px; height: 42px; border-radius: 10px; display: grid; place-items: center; }
    .zi-kpi__icon svg { width: 20px; height: 20px; }
    .zi-kpi__icon--total    { background: rgba(var(--bs-primary-rgb), .12); color: var(--bs-primary); }
    .zi-kpi__icon--active   { background: rgba(var(--bs-success-rgb), .12); color: var(--bs-success); }
    .zi-kpi__icon--inactive { background: rgba(var(--bs-danger-rgb), .12);  color: var(--bs-danger); }
    .zi-kpi__label { font-size: .78rem; color: #6e6b7b; text-transform: uppercase; letter-spacing: .04em; }
    .zi-kpi__value { font-size: 1.5rem; font-weight: 600; line-height: 1.2; color: #5e5873; }
...
<section id="zipcodes-list">
    ...
    <div class="zi-kpis">
        <div class="zi-kpi">
            <div class="zi-kpi__icon zi-kpi__icon--total"><i data-feather="layers"></i></div>
            <div>
                <div class="zi-kpi__label">Total</div>
                <div class="zi-kpi__value" data-stat="total">{{ $stats['total'] }}</div>
            </div>
        </div>
        <div class="zi-kpi">
            <div class="zi-kpi__icon zi-kpi__icon--active"><i data-feather="check-circle"></i></div>
            <div>
                <div class="zi-kpi__label">Active</div>
                <div class="zi-kpi__value" data-stat="active">{{ $stats['active'] }}</div>
            </div>
        </div>
        <div class="zi-kpi">
            <div class="zi-kpi__icon zi-kpi__icon--inactive"><i data-feather="slash"></i></div>
            <div>
                <div class="zi-kpi__label">Inactive</div>
                <div class="zi-kpi__value" data-stat="inactive">{{ $stats['inactive'] }}</div>
            </div>
        </div>
    </div>
