                    ...
                    @forelse ($subcategories as $sub)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                @else
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-danger js-delete-blocked" aria-disabled="true" title="Cannot delete" data-reason="Cannot delete '{{ $sub->name }}' — it has linked products. Remove them first."><i data-feather="trash-2"></i></button>
                                @endif
                            </td>
                        </tr>
                    @empty
