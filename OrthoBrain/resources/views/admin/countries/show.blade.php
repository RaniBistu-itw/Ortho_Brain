...
@section('content')
<div class="mb-5">
    <h1 class="text-2xl font-semibold text-[#5e5873]">View Country</h1>
</div>
<div class="bg-white border border-[#ebe9f1] rounded-lg p-6">
    ...
    <div class="mt-6 flex gap-3">
        <a href="{{ route('admin.countries.edit', $country) }}" class="px-5 py-2 bg-[#5bc0de] hover:bg-[#46b8da] text-white text-sm font-medium rounded-md shadow-sm">Edit</a>
        <a href="{{ route('admin.countries.index') }}" class="px-5 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-md">Back</a>
    </div>
</div>
@endsection
