    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto">
                <a wire:navigate class="navbar-brand" href="{{ route('doctor.dashboard') }}">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ $active('doctor.dashboard') }}">
                <a wire:navigate href="{{ route('doctor.dashboard') }}" class="d-flex align-items-center">
            ...
            <li class="nav-item {{ $active('doctor.cases.*') }}">
                <a wire:navigate href="{{ route('doctor.cases.index') }}" class="d-flex align-items-center">
